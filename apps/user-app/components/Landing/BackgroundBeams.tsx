...
const BackgroundBeams = () => {
  const paths = [
    // reduced beams for to smooth performance
  ...
  return (
    <div
      className={cn(
        'scroll-smooth absolute h-[250vh] w-full inset-0 [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center'
      )}
      style={{
