  ...
  return (
    <div className="">
      ...
      <div className="min-h-screen flex items-center justify-center relative" style={{
        ...
        <div className="relative backdrop-blur-xl bg-black/5 dark:bg-white/5 border border-gray-500/30 rounded-xl w-[35rem] shadow-xl p-10 max-w-lg text-black dark:text-white">
