    ...
    return (
        <div className="min-h-screen pt-20 px-8 bg-transparent text-black dark:text-white">
            <div className="max-w-7xl mx-auto">
                <h1 className="font-bold text-3xl text-center mb-10">Money Transfer</h1>
                                    ...
                                    <div className="h-[80%] pt-2 text-4xl relative group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (
                                                    (/^\d{0,6}(\.(?!0{1,2}$)\d{1,2})?$/.test(value) || value === "") &&
                                                    value.length <= 9
                                                ) {
                                                    setAmountError("");
                                        ...
                                        />
                                        {amountError && (
                                            <div className="text-xs font-semibold text-red-500 mt-5">{amountError}</div>
                                        )}
                                    </div>
                                </div>
